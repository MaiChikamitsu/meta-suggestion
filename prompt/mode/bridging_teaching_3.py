def bridging_teaching_mode_3(meta_suggestion, user_input, conversation, comprehension_problem, comprehension_level, concreteness_problem, confidence_prompt, advice, answer):
    prompt = f"""
    ユーザーが問題に取り組んでいます。
    問題の内容は添付画像に示したとおりです。
